...
contract Crowdsale is Ownable{
    ...
    */
	...
	/* Maximum number of DGCT to pre ico sell */
	uint public constant PRE_MAX_CAP = 750000000 * 10**18; // 750,000,000 DGCT

	/* Maximum number of DGCT to main ico sell */
	uint public constant MAIN_MAX_CAP = 1250000000 * 10**18; // 1,250,000,000 DGCT

	/* Minimum amount to invest */
	uint public constant MIN_INVEST_ETHER = 100 finney;

	/* Crowdsale period */
	uint private constant PRE_START_TIME = 1527904800; 	// 2018-06-02 10:00 AM (GMT + 08:00)
	uint private constant PRE_END_TIME = 1529632800;  	// 2018-06-22 10:00 AM (GMT + 08:00)
	uint private constant MAIN_START_TIME = 1530756000;	// 2018-07-05 10:00 AM (GMT + 08:00)
	uint private constant MAIN_END_TIME = 1533434400;	// 2018-08-05 10:00 AM (GMT + 08:00)

	/* Number of DGCT per Ether */
	uint public constant PRE_COIN_PER_ETHER_ICO = 12500 * 10**18; // 12,500 DGCT
	...
	*/
	...
	uint public maximumCoinsPerAddress = 100 ether;
	...
	/* Number of DGCT sent to Ether contributors during pre ico */
	...
	*/
	...
	/*
	*	Durign the pre ico, should be called by owner to send DGCT to beneficiary address
	*/
	function preSendDGCT() onlyOwner public {
